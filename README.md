...
Migration guides are now part of the website documentation:

- [Migration overview](https://tobitsoftware.github.io/chayns-toolkit/docs/migrations)
- [Migration v2 to v3](https://tobitsoftware.github.io/chayns-toolkit/docs/migrations/v2-to-v3)

Future migration guides, including **v3 to v4**, will also be published there.
